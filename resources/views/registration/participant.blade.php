...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center"><b>Participant Registration</b></div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('participantRegistrationSubmit') }}" enctype="multipart/form-data">
                            @csrf
